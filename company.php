...
<head>
    ...
    <title>Company Login - Online Job Finding System</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .login-card { background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 40px; width: 100%; max-width: 450px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); }
        .login-card h3 { font-size: 24px; font-weight: 700; color: #1a1a1a; margin-bottom: 25px; text-align: center; }
        ...
        .form-input { width: 100%; padding: 12px 16px; border: 1px solid #000000; border-radius: 8px; font-size: 15px; outline: none; transition: 0.3s; background-color: #f8fafc; }
        .form-input:focus { border-color: black; background-color: #fff; box-shadow: 0 0 0 3px rgba(0, 176, 116, 0.1); }
        ...
        /* Link Section */
        .register-link { text-align: center; margin-top: 20px; font-size: 14.5px; color: #666; }
        .register-link a { color: #002fb0; text-decoration: none; font-weight: 600; transition: 0.2s; }
        .register-link a:hover { text-decoration: underline; }

        /* Footer */
        .footer { background: #111; color: white; padding: 20px 20px; text-align: center; margin-top: auto; border-top: 1px solid #222; }
...
<body>
    ...
    <div class="navbar">
        ...
        <div class="nav-container">
            ...
            <a href="company.php" class="nav-item active">Company</a>
        </div>
    </div>

    <!-- Page Title Banner -->
    <div class="page-banner">
        <h2>Employer <span>Portal</span></h2>
        <p>Log in to post job vacancies, manage applicants, and find top talent.</p>
    </div>

    <!-- Main Content Area -->
    <div class="login-container">
        <div class="login-card">
            <h3>Company <span>Login</span></h3>
            
            <form action="" method="post">
                <!-- Username Input -->
                <div class="form-group">
                    <label for="username" class="form-label">Company Username</label>
                    <input type="text" id="username" name="username" placeholder="Enter company username" class="form-input" value="<?php echo htmlspecialchars($username); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" placeholder="Enter password" class="form-input">
            ...
            <div class="register-link">
                Don't have a Company Account? <a href="companyregister.php">Register Company</a>
            </div>
        </div>
    </div>
