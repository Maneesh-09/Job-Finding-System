...
if (isset($_SESSION["username"])) {
    ...
    <head>
        ...
        <title>Admin Dashboard - Accepted Applications</title>
        <style>
        ...
        <div class="dashboard-layout">
            ...
            <div class="sidebar">
                <ul class="nav-links">
                    ...
                    <li><a href="allacceptedapplicant.php" class="active">All Accepted Applicants</a></li>
            ...
            <div class="main-content">
                ...
                <div class="page-title-section">
                    ...
                    <p>Review and audit candidates who have successfully passed the screening and interview phases.</p>
                </div>

                <!-- Accepted Applications Data Grid -->
                <?php if (mysqli_num_rows($result) > 0) { ?>
                    <div class="table-card">
                        <h3 style="font-size: 17px; font-weight: 700; color: #1e293b; margin-bottom: 5px;">Approved Talent Pool</h3>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="date-text"><?php echo date("d-m-Y", strtotime($row['accepted_at'])); ?></span></td>
                                            <td><a href="uploads/<?php echo urlencode($row['cv']); ?>" target="_blank" class="cv-link">📄 View CV</a></td>
                                            <td align="center">
                                                <div class="action-holder">
                                                    <button class="action-btn delete-btn" onclick="if(confirm('Are you sure you want to permanently delete this record from accepted applications archive?')) window.location.href='admindeleteacceptedapplication.php?id=<?php echo $row['id']; ?>';">Delete</button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
                ...
                <?php } else { ?>
                    <div class="no-data-msg">
                        <p>🔍 No accepted candidate records found in the database logs.</p>
                    </div>
                <?php } ?>
