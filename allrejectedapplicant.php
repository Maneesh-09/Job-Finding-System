...
if (isset($_SESSION["username"])) {
    ...
    <head>
        ...
        <title>Admin Dashboard - Declined Applications</title>
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
            ...
            table { width: 100%; border-collapse: collapse; text-align: left; font-size: 14.5px; min-width: 1300px; }
            ...
            .job-accent { font-weight: 600; color: #de3e3e; }
        ...
        <div class="dashboard-layout">
            ...
            <div class="sidebar">
                <ul class="nav-links">
                    ...
                    <li><a href="allrejectedapplicant.php" class="active">All Rejected Applicants</a></li>
                </ul>
            </div>
            ...
            <div class="main-content">
                ...
                <div class="page-title-section">
                    ...
                    <p>Review and audit technical profiles that did not fulfill corporate requirements or evaluation criteria.</p>
                </div>

                <!-- Declined Applications Data Grid -->
                <?php if (mysqli_num_rows($result) > 0) { ?>
                    <div class="table-card">
                        <h3 style="font-size: 17px; font-weight: 700; color: #1e293b; margin-bottom: 5px;">Declined Talent Records</h3>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><code><?php echo htmlspecialchars($row['application_id']); ?></code></td>
                                            ...
                                            <td><span class="date-text"><?php echo date("d-m-Y", strtotime($row['rejected_at'])); ?></span></td>
                                            <td><a href="uploads/<?php echo urlencode($row['cv']); ?>" target="_blank" class="cv-link">📄 View CV</a></td>
                                            <td align="center">
                                                <div class="action-holder">
                                                    <button class="action-btn delete-btn" onclick="if(confirm('Are you sure you want to permanently delete this record from declined applications archive?')) window.location.href='admindeletedeclinedapplication.php?id=<?php echo $row['id']; ?>';">Delete</button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
                ...
                <?php } else { ?>
                    <div class="no-data-msg">
                        <p>🔍 No declined application registries found inside the archive log grid.</p>
                    </div>
                <?php } ?>
